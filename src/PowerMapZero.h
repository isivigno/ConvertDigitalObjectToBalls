 ...
 *
 * @see testPowerMapZero.cpp
 */

#if defined(PowerMapZero_RECURSES)
#error Recursive header files inclusion detected in PowerMapZero.h
#else // defined(PowerMapZero_RECURSES)
/** Prevents recursive inclusion of headers. */
#define PowerMapZero_RECURSES

#if !defined PowerMapZero_h
/** Prevents repeated inclusion of headers. */
#define PowerMapZero_h
...
namespace DGtal
{
  ...
  /////////////////////////////////////////////////////////////////////////////
  // template class PowerMapZero
  /**
   * Description of template class 'PowerMapZero' <p>
   ...
   * PowerMapZero (default: ImageContainerBySTLVector). The space of the
  ...
  public:
    ...
    ///Self type
    typedef PowerMapZero<TWeightImage, TPowerSeparableMetric, TImageContainer> Self;
     ...
     */
    PowerMapZero(ConstAlias<Domain> aDomain,
  ...
  public:
     ...
     *
     *  @param aOtherPowerMapZero another instance of Self
     *  @return a reference to Self
     */
    Self &  operator=(const Self &aOtherPowerMapZero ) = default;
 ...
 /**
  ...
  template <typename W,
            ...
            typename Image>
  std::ostream&
  operator<< ( std::ostream & out, const PowerMapZero<W,Sep,Image> & object );
...
#include "PowerMapZero.ih"

//                                                                           //
///////////////////////////////////////////////////////////////////////////////

#endif // !defined PowerMapZero_h

#undef PowerMapZero_RECURSES
#endif // else defined(PowerMapZero_RECURSES)
